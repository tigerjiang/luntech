...
import com.luntech.launcher.ListUtils;
...
public class ImagePagerAdapter extends RecyclingPagerAdapter {
    ...
    public ImagePagerAdapter(Context context, List<Drawable> imageIdList) {
    ...
    public View getView(int position, View view, ViewGroup container) {
        ...
        holder.imageView.setImageDrawable(imageIdList.get(getPosition(position)));
        return view;
    }
